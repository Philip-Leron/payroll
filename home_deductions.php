          ...
          <ul class="nav nav-justified">
            ...
            <li>
              ...
              <form class="form-horizontal" action="#" name="form">
                ...
                <div class="form-group">
                  <label class="col-sm-5 control-label">SSNIT :</label>
                  <div class="col-sm-4">
                    <?php echo $bir; ?>.00
                  </div>
                </div>
                <div class="form-group">
                  <label class="col-sm-5 control-label">NHIA  :</label>
                  <div class="col-sm-4">
                    <?php echo $gsis; ?>.00
                  </div>
                </div>
                <div class="form-group">
                  <label class="col-sm-5 control-label">Contributions  :</label>
                  <div class="col-sm-4">
                    <?php echo $love; ?>.00
                  </div>
                </div>
